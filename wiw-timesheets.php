...
// === WIWTS FLAG 104 EXTRA TIME ACTION HANDLER START ===
    ...
    public function handle_flag104_extra_time_action()
    {
        ...
        $new_payable = $this->round_up_hours_to_quarter((float) $new_payable);
        ...
        foreach ($rows as $dr) {
            ...
            if ($has_flag_104) {
                ...
                if ($show_flag104_preview) {
                    ...
                    $new_payable_104 = $this->round_up_hours_to_quarter($current_payable_104 + (float) $extra_hours_104);
                        ...
                        if ($dt_out_fix <= $dt_in_fix) {
                            ...
                            if ($sched_start_raw_fix !== '' || $sched_end_raw_fix !== '') {
                                ...
                                if ($pay_out_fix <= $pay_in_fix) {
                                    ...
                                    $new_payable_val = $this->round_up_seconds_to_quarter_hours($psec_fix);
                                }
                            }
...
public function wiwts_run_auto_approve_past_due_with_autofix(): array
{
    ...
    foreach ($rows as $entry) {
        ...
        if ($has_flag_104 && strtolower($existing_extra_status) !== 'confirmed' && $sched_end !== '' && $clock_out_for_104 !== '') {
            ...
            if ($extra_hours_104 > 0.0) {
                $new_payable_104 = $this->round_up_hours_to_quarter($payable_for_104 + $extra_hours_104);
...
<?php
        ...
        try {
            ...
            if ($sched_start_raw !== '' || $sched_end_raw !== '') {
                ...
                if ($pay_out <= $pay_in) {
                    ...
                    $payable_hours = $this->round_up_seconds_to_quarter_hours($psec);
                }
            }
        } catch (Exception $e) {
    ...
    public function ajax_client_update_entry()
    {
            ...
            try {
                ...
                if ($sched_start_raw !== '' || $sched_end_raw !== '') {
                    ...
                    if ($pay_out > $pay_in) {
                        ...
                        $payable_hours     = $this->round_up_minutes_to_quarter_hours($pay_minutes);
                    } else {
                        $payable_hours = 0.00;
                    }
                }
        ...
        $payable_hours_2  = (float) $this->round_up_hours_to_quarter($payable_hours);
                    ...
                    if ($dt_out > $dt_in) {
                        ...
                        try {
                            ...
                            if ($pay_end > $pay_start) {
                                ...
                                $payable_hours       = $this->round_up_minutes_to_quarter_hours($payable_minutes);
		 ...
		 WHERE wiw_time_id = %d
		   AND flag_type LIKE %s",
            ...
            if ($sh_109 !== null && $ph_109 !== null) {
                ...
                $new_109_status = ($this->round_up_hours_to_quarter($sh_109) !== $this->round_up_hours_to_quarter($ph_109)) ? 'active' : 'resolved';
            }
